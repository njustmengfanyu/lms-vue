...
<!--            </template>-->
<!--            <template-->
<!--                v-for="col in ['id', 'title', 'author', 'date', 'press']"-->
<!--                :slot="col"-->
...
<!--                    </span>-->
<!--                    <span v-else>-->
<!--&lt;!&ndash;                        <a :disabled="editingKey !== ''" @click="() => edit(record.id)">编辑</a>&ndash;&gt;-->
...
<!--                </el-form-item>-->
<!--                &lt;!&ndash;                <el-form-item label="状态" :label-width="formLabelWidth" prop="enabled">&ndash;&gt;-->
<!--                &lt;!&ndash;                    <el-input v-model="form.enabled" autocomplete="off"></el-input>&ndash;&gt;-->
...
<!--        onSubmit() {-->
<!--            this.$axios-->
<!--                .put('/admin/content/books', {-->
<!--                    id: this.dialogForm_id,-->
<!--                    username: this.form.title,-->
<!--                    name: this.form.author,-->
<!--                    phone: this.form.date,-->
<!--                    email: this.form.press,-->
...
<template>
    <div>
        ...
        >
            ...
            <template
                v-for="col in ['id', 'cover', 'title', 'author', 'date', 'enabled', 'press']"
                :slot="col"
                slot-scope="text, record, index"
            >
                <div :key="col">
        ...
        <el-dialog
            ...
            <el-form v-model="form" style="text-align: left" ref="dataForm">
                ...
                <el-form-item label="封面" :label-width="formLabelWidth" prop="cover">
                    <el-input v-model="form.cover" autocomplete="off" :placeholder="dialogForm_cover"></el-input>
                </el-form-item>
                <el-form-item label="书籍名称" :label-width="formLabelWidth" prop="title">
                    <el-input v-model="form.title" autocomplete="off" :placeholder="dialogForm_title"></el-input>
                </el-form-item>
...
export default {
    ...
    methods: {
        ...
        editNode:function (item){
            ...
            this.dialogForm_title=item.title
